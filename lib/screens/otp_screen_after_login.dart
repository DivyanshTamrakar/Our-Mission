...
class OTPScreenAfterLogin extends StatefulWidget {
  final String contact;
  OTPScreenAfterLogin({Key key,this.contact}):super(key: key);
  @override
  _OTPScreenAfterLoginState createState() => _OTPScreenAfterLoginState();
}

class _OTPScreenAfterLoginState extends State<OTPScreenAfterLogin> {
                          ...
                          if(_otpPin.length==6) {
                            try{
                              ...
                              var resp = await HttpResponse.postResponse(
                                  service: '/users/signin', data: data);
                              print("\n\n$resp\n\n");
                              print(data);
